   ...
   <div class="containerbody">
    ...
    <table border="0">
        <tr>
            <td>
                <div class="card">
                    <img src="<?php echo e(asset ('images')); ?>/iphone13pro.png" height="250px" alt="Iphone 13 Pro" style="width:250px; padding-top: 30px">
            ...
            <td>
                <div class="card">
                    <img src="<?php echo e(asset ('images')); ?>/redminote11pro.jpg" height="265px" alt="Iphone 13 Pro" style="width:250px; padding-top: 10px">
            ...
            <td>
                <div class="card">
                    <img src="<?php echo e(asset ('images')); ?>/macbookair.png" height="180px" alt="Iphone 13 Pro" style="width:250px; padding-top:25px; margin-top:40px; margin-bottom:25px;">
            ...
            <td>
                <div class="card">
                    <img src="<?php echo e(asset ('images')); ?>/iphone13pro.png"height="250px" alt="Iphone 13 Pro" style="width:250px">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecommerce-app\resources\views/home.blade.php ENDPATH**/ ?>